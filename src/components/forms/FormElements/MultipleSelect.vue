<template>
  <div class="relative" ref="multiSelectRef">
    ...
    >
      ...
      <div class="flex flex-wrap items-center flex-auto gap-2">
        <div
          ...
          :key="item.value"
          class="group flex items-center justify-center rounded-full border-[0.7px] border-transparent bg-gray-100 py-1 pl-2.5 pr-2 text-sm text-gray-800 hover:border-gray-200 dark:bg-gray-800 dark:text-white/90 dark:hover:border-gray-800 h-auto"
        >
    ...
    >
      <div
        v-if="isOpen"
        class="absolute z-50 w-full mt-1 bg-white rounded-lg shadow-sm dark:bg-gray-900 border border-gray-200 dark:border-gray-700"
      >
        <ul
